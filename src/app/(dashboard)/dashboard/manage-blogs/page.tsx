...
export default function ManageBlog() {
  ...
  const blogColumns: ColumnDef<Blog>[] = useMemo(() => [
    ...
    },
    {
      ...
      cell: ({ row }) => <div className="text-center font-mono text-sm">{row.getValue("views")}</div>,
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex justify-start space-x-1">
            <Button className='cursor-pointer' variant="ghost" size="icon" onClick={() => handleAction('View')} title="View Post">
              <Eye className="h-4 w-4 text-blue-500" />
            </Button>
            <Button className='cursor-pointer' variant="ghost" size="icon" onClick={() => handleAction('Edit')} title="Edit Post">
              <Edit className="h-4 w-4 text-yellow-500" />
            </Button>
            <Button className='cursor-pointer' variant="ghost" size="icon" onClick={() => handleAction('Delete')} title="Delete Post">
