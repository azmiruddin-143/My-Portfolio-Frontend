...
// // Note: deleteBlog function is passed via table.options.meta
...
//       // Access the openConfirmDialog function from meta
//       const { openConfirmDialog } = table.options.meta as { openConfirmDialog: (blog: Blog) => void };

//       const handleAction = (action: 'View' | 'Edit' | 'Delete') => {
//         if (action === 'Delete') {
//           openConfirmDialog(blog); // Open the dialog instead of direct deletion
//         } else if (action === 'Edit') {
...
//   // ✅ ডেটা ফেচিং লজিক (আগের মতোই)
//   useEffect(() => {
//     const fetchBlogs = async () => {
//       // ... [fetch logic remains the same] ...
//       try {
//         const response = await fetch("http://localhost:5000/api/v1/blog", { credentials: "include" });
...
//     // ✅ 3. AlertDialog ফাংশনটি table instance এর meta প্রপার্টিতে পাস করা হলো
//     meta: {
//         openConfirmDialog,
//     },
//     state: {
      ...
      cell: ({ row }) => { 
        ...
        const handleAction = (action: 'View' | 'Edit' | 'Delete') => {
          if (action === 'Delete') {
            ...
            router.push(`/dashboard/blogs/edit/${blog.id}`); // ✅ Edit Navigation
          } else if (action === 'View') {
